...
使用方法：
    python -m lagrange_01.scripts.demo_pusht_real -o data/pusht_real_demo.zarr
...
@click.option('--camera-id', default=0, type=int, help='相机ID')
def main(output, control_hz, mouse_window, camera_id):
    """
    采集实机 PushT 任务的演示数据。
    """
    ...
    target_orientation = current_orientation.copy()  # 保持初始姿态
